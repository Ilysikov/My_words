...
class Ui_MainWindow(QMainWindow):
    def __init__(self,MainWindow:QtWidgets.QMainWindow)->None:
        ...
        self.lineEdit_NT_input_field_russian = self.create_line(name="lineEdit_NT_input_field_russian",
                                                                ...
                                                                tabwidget=self.tabWidget_new_word)
        # -//- для записи Транслитерации слова
        ...
        # добавление вкладки 1 к базовому виджету
        ...
        # привязка виджетов к "сетке" на вкладке 1
    ...
    def retranslateUi(self, MainWindow)->None:
        ...
        # присваение текста и события 1 кнопке переключения языка
        ...
        # self.count_table - ссылается на число слов
