...
class W_search:
    ...
    def count_tab(self)->int:
        v=my_tabs()
        v.cursor_()
        v.select_(search_="COUNT(english)", tab_="words_")
...
class New_word:
    ...
    def app_word(self, dict_word: str)->list:
    ...
    def new_word_(self)->None:
        ...
        slc.lab(str_01=self.text_.i_text(key_='nt_1_03',
                                        ...
                                        str_05=self.text_.i_text(key_='t_05', list_dic={'self.count_table':count}))
...
class See_word(W_search):
    ...
    def my_select(self, number: int)->object:
    ...
    def play(self)->None:
        ...
        if self.count_table>0:
            ...
            s=self.my_select(number=self.number)
...
class Chek(See_word):
    ...
    def check_word(self)->None:
        ...
        if self.number and answer:
            x=self.my_select(number=self.number)
...
class Search_prog:
    ...
    def search_(self, answer: str, question: str, percent: float)->None: 
        self.answer_0=answer
        self.question=question
        self.percent=percent
        v=my_tabs()
        v.cursor_()
        v.select_(search_="COUNT(answer)", tab_="progress_")
        self.count_table_two=v.fetchone_()
    ...
    def progress_(self)->None:
        ...
        if not num_:
            ...
            self.num=num_
        self.list_03=[]
        level_dic={800:"A1 (Elementary)", 2000:"А2 (Pre-intermediate)", 3500:"B1 (Intermediate)", 6000:"B2 (Upper-Intermediate)", 10000:"C1 (Advanced)", 16000:"C2 (Proficient)"}
